...
/** @type {string} */
const CACHE_VERSION = '1762271437|4127999468';
/** @type {string} */
const CACHE_PREFIX = 'tutorial_ITK-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tut.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tut.html","tut.js","tut.offline.html","tut.icon.png","tut.apple-touch-icon.png","tut.audio.worklet.js","tut.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tut.wasm","tut.pck","tut.side.wasm"];
